...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        jumpAction.canceled += OnJumpUpInput;
    }

    private void OnDisable()
    {
        // Unsubscribe from jump input events
        jumpAction.performed -= OnJumpInput;
        jumpAction.canceled -= OnJumpUpInput;
    }
    ...
    private void WallJump(int dir)
    {
        ...
        if (RB.linearVelocity.y < 0) //checks whether player is falling, if so we subtract the linearVelocity.y (counteracting force of gravity). This ensures the player always reaches our desired jump force or greater
